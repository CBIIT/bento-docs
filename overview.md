...
## Introduction
Bento is an open-source framework that supports the creation of data sharing platforms that allow users to store, manage, share and analyze large-scale data according to the [FAIR](https://www.go-fair.org/fair-principles/) principles.

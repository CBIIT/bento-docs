...
3. Open the `.env` file using a text editor of your choice. 
    ...
    * Set the variable BUILD_MODE to `dev`. Note: see [Installing Bento on you Local Machine](installation/installing-bento-on-your-local-machine) for a discussion on the three modes for Bento local environment.

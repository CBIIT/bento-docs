...
3. Open the `vars.tfvars` file with an editor of your choice. The path of this file is: `src/bento-custodian/terraform/aws/vars.tfvars`. See `$src/bento-custodian/terraform/aws/variables.tf` for a description of the variables in `vars.tfvars`.
...
See below for an example `vars.tfvars` file:
